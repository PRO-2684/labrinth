...
Generated Rust client for the Labrinth API. See:

- [docs.rs/labrinth](https://docs.rs/labrinth) for library documentation
- [`DEV-NOTES.md`](./docs/DEV-NOTES.md) for development notes and instructions
- [`./labrinth`](./labrinth) for the source code of the generated lib
- [`./template`](./template) for the template used to generate the lib (should be generic enough to be used for other OpenAPI specs with little or none changes)
